...
- **ATOK Spark** を使ってみた。
  ...
  - 自作いただいた定義ファイルやプラグインは、作成した方のものです。定義ファイルやプラグインを公開する際には、ATOK Sparkリポジトリをforkして差分をコミットするのではなく、新しいリポジトリを作成・保存しそのリンクをIssueで投稿してください。
...
**アップデートのお知らせ**
 * 2016/9/1 - Windows版/Mac版  v1.0.2.0 公開
