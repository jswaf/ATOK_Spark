...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/atoksparkhelp">
    <html>
      ...
      <body>
      <h1 style="font-size: 1.5em; padding: .5em .75em; background-color: #f6f6f6; border-bottom: 1px solid #ccc;">ATOK Spark 定義フレーズ 検索【 #ATOK::DEFINE::TEXT[1]# 】</h1>
  ...
  <xsl:template match="help[contains(string(),&quot;#ATOK::DEFINE::TEXT[1]#&quot;)]">
  		<xsl:apply-templates select="Guidance" />
		<div style="padding: 8px 2px 8px 8px;">
	  		<xsl:apply-templates select="Detail" />
	  		<xsl:apply-templates select="Example" />
